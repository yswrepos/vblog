import{_ as n,o as s,c as e,e as a}from"./app-BLeSCfhf.js";const i={},t=a(`<p>在OpenWrt系统上创建一个名为<code>br3</code>的新桥接接口并在其上启动一个访客网络涉及几个步骤，包括配置网络接口、设置无线接入点和定义防火墙规则以隔离访客网络。以下是一个基本的步骤指南：</p><h3 id="_1-创建桥接接口" tabindex="-1"><a class="header-anchor" href="#_1-创建桥接接口"><span>1. 创建桥接接口</span></a></h3><p>首先，确保<code>br3</code>接口尚未创建。如果需要创建，你可以参考之前关于如何添加桥接接口的说明。对于OpenWrt，通常你会直接在Web界面（LuCI）中操作或编辑<code>/etc/config/network</code>文件。</p><h3 id="_2-配置网络接口" tabindex="-1"><a class="header-anchor" href="#_2-配置网络接口"><span>2. 配置网络接口</span></a></h3><p>编辑<code>/etc/config/network</code>文件，添加一个新的接口配置段落。例如，为<code>br3</code>创建一个新的接口并配置其为静态IP或DHCP客户端（根据你的网络需求）。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>config interface <span class="token string">&#39;guest&#39;</span>
